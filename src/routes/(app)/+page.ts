...
export const load: PageLoad = async ({ fetch }) => {
  ...
  const defaultMeditation = {
    ...
    short: "Aujourd'hui est un cadeau unique que nous recevons des mains de notre Créateur. C'est une invitation à choisir la joie et l'allégresse, à célébrer cette bénédiction et à vivre pleinement chaque moment avec gratitude.",
  };
  try {
